 ...
 * <b>Complexity: O(n)</b>, having n as the number of lines in the file.
 ...
 * <b>Complexity: O(n)</b>, having n as the number of airlines.
 */
 ...
 * <b>Complexity: O(n)</b>, having n as the number of airports.
 ...
 * <b>Complexity: O(n * m)</b>, having n as the number of airports and m the number of flights in an airport.
